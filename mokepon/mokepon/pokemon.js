...
class Mokepon {
  constructor(nombre, foto, fotoMapa, vida, x = 10, y = 10, id = null) {
    this.id = id
    this.nombre = nombre;
    this.foto = foto;
    this.vida = vida;
...
function iniciarJuego() {
  ...
  mokepones.forEach((mokepon) => {
    ...
    contenedorTargetas.innerHTML += opcionesDeMokepones;
...
function ataqueAleatorioEnemigo() {
  console.log('ataques enemigo', ataquesMokeponesEnemigo)
...
function seleccionarMascotaEnemigo(enemigo) {
  ...
  ataquesMokeponesEnemigo = enemigo.ataque
  secuenciaAtaque();
}
